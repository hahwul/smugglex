...
### Added
- Opt-in parser-discrepancy, CL.0, and 0.CL checks. The new audits compare
  framing controls and same-connection response queues, require reproducible
  desynchronization signals, and expose diagnostics suitable for JSON output.
