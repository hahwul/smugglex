...
smugglex is a powerful HTTP Request Smuggling testing tool written in Rust. It's designed for security testing and penetration testing to detect various types of HTTP request smuggling vulnerabilities.
